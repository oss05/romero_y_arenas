...
import imgAreas from "../img/service.png"
        ...
        <div>
            ...
            <main>
                <div className="areas_de_servicio">
                    <div className="titulo_areas_servicio  d-flex justify-content-center align-items-center">
                        {/* <img className="titulo_areas_servicio" src={imgAreas} alt /> */}
                        <p>{props.data.secciones.areas.nombre}</p>
                    </div>
                </div>
                ...
                {/* ------Boletines y Mapa----------- */}
                <Link to="/boletines" style={{textDecoration: "none"}} className="d-none d-lg-block">
                    <div className="seccion_boletines d-flex justify-content-center align-items-center"> 
                        <p style={{fontSize: "4em", color: "#000"}}>{props.data.secciones.boletines.nombre}</p>
                    </div>
                </Link>
